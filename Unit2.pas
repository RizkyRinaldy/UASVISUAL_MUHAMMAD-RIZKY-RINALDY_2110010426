...
begin
  ...
  zqry1.SQL.Clear;
  zqry1.SQL.Add('Update data_siswa set nisn="'+edt1.Text+'",nis="'+edt2.Text+'",nik="'+edt3.Text+'",nama="'+edt4.Text+'",tempat_lahir="'+edt5.Text+'",tanggal_lahir="'+formatdatetime('yyyy-mm-dd',dtp1.date)+'",jenis_kelamin="'+edt6.Text+'",kelas="'+edt7.Text+'",jurusan="'+edt8.Text+'",wali_kelas="'+edt9.Text+'",alamat="'+edt10.Text+'",no_telpon="'+edt11.Text+'",status="'+edt12.Text+'" where id ="'+id+'"');
  zqry1.ExecSQL;
